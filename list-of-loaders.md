...
* [`callback`](https://github.com/Kreozot/callback-loader): Parses your JS, calls specified functions (which you implement in webpack context) and replaces their with the results.
