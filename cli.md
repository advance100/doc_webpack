...
> Note: When working with NFS devices you'll need to set `watchOptions.poll: true` to receive file changes, as stated in this [chokidar issue](https://github.com/paulmillr/chokidar/issues/242).
